...
template void build_grid<6>(FunctionTree<6> &out, int scales);
...
template void build_grid<6>(FunctionTree<6> &out, const GaussExp<6> &inp, int maxIter);
...
template void build_grid<6>(FunctionTree<6> &out, const RepresentableFunction<6> &inp, int maxIter);
...
template void build_grid<6>(FunctionTree<6> &out, FunctionTree<6> &inp, int maxIter);
...
template void build_grid<6>(FunctionTree<6> &out, FunctionTreeVector<6> &inp, int maxIter);
...
template void build_grid<6>(FunctionTree<6> &out, std::vector<FunctionTree<6> *> &inp, int maxIter);
...
template void copy_func<6>(FunctionTree<6> &out, FunctionTree<6> &inp);
...
template void copy_grid<6>(FunctionTree<6> &out, FunctionTree<6> &inp);
...
template void clear_grid<6>(FunctionTree<6> &out);
...
template int refine_grid<6>(FunctionTree<6> &out, int scales);
...
template int refine_grid<6>(FunctionTree<6> &out, double prec, bool absPrec);
...
template int refine_grid<6>(FunctionTree<6> &out, FunctionTree<6> &inp);
